      ...
      <div className="section-container">
        ...
        <div className="mt-16 pt-16 border-t border-gray-100">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            ...
            <div className="flex flex-col items-center">
              <img 
                src="https://upload.wikimedia.org/wikipedia/he/5/56/Canva-logo.png" 
                alt="Canva" 
                className="h-12 w-12 mb-2 object-contain"
              />
            ...
            <div className="flex flex-col items-center">
              <img 
                src="https://img.icons8.com/?size=100&id=vIbsCQXkSp6l&format=png&color=000000" 
            ...
            <div className="flex flex-col items-center">
              <img 
                src="https://cdn.prod.website-files.com/64ea57571d50b02423c4505d/64fb219ade937671b42e011e_capcut%20logo%20png.png" 
                alt="CapCut" 
                className="h-12 w-12 mb-2 object-contain"
              />
